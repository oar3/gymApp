<x-layout>
    ...
    <form method="POST" action="/templates" id="create-template-form">
        @csrf

        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base/7 font-bold text-gray-600">Create a New Workout Template</h2>
                <p class="mt-1 text-sm/6 text-gray-500">Create a reusable workout template that you can use in the future.</p>

                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        <x-form-label for="name">Template Name</x-form-label>
                        <div class="mt-2">
                            <x-form-input type="text" name="name" id="name" :value="old('name')" placeholder="e.g., Leg Day, Upper Body, etc." required />
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a href="/templates" class="text-sm/6 font-semibold text-gray-600">Cancel</a>
            <x-form-button>Save Template</x-form-button>
        </div>
    </form>
